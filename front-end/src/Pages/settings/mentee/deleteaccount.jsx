...
export default function MenteeDeleteAccount() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await axios.delete('http://localhost:5000/mentee/delete-account', {
  ...
  return (
    <div className="delete-container">
      <h1>Delete Your Mentee Account</h1>
      <p className="warning-text">
        This action is <strong>permanent</strong> and will delete all your mentee data.
      </p>
