...
import Settings from '../Pages/settings/mentee/menteesettings';

jest.mock('../Pages/settings/mentee/account', () => () => <div data-testid="account">Account Component</div>);
jest.mock('../Pages/settings/mentee/privacy', () => () => <div data-testid="privacy">Privacy Component</div>);
jest.mock('../Pages/settings/mentee/help', () => () => <div data-testid="help">Help Component</div>);
jest.mock('../Pages/settings/mentee/deleteaccount', () => () => <div data-testid="delete">Delete Account Component</div>);
